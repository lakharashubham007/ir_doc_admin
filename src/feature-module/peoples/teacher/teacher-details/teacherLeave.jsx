...
const TeacherLeave = () => {
  ...
  const columns = [
    ...
    },
    {
      title: "Leave Date",
      dataIndex: "leaveDate",
      sorter: (a, b) => a.leaveDate.length - b.leaveDate.length,
    },
    {
      title: "No of Days",
      dataIndex: "noOfDays",
      sorter: (a, b) => parseFloat(a.noOfDays) - parseFloat(b.noOfDays),
    },
    {
      title: "Applied On",
      dataIndex: "appliedOn",
  ...
  const columns2 = [
    ...
    },
    {
      ...
      sorter: (a, b) => a.jan.length - b.jan.length,
    },
    {
        title: "feb",
        dataIndex: "feb",
        ...
        sorter: (a, b) => a.feb.length - b.feb.length,
      },
      {
        title: "mar",
        dataIndex: "mar",
        ...
        sorter: (a, b) => a.mar.length - b.mar.length,
      },
      {
        title: "apr",
        dataIndex: "apr",
        ...
        sorter: (a, b) => a.apr.length - b.apr.length,
      },
      {
        title: "may",
        dataIndex: "may",
        ...
        sorter: (a, b) => a.may.length - b.may.length,
      },
      {
        title: "jun",
        dataIndex: "jun",
        ...
        sorter: (a, b) => a.jun.length - b.jun.length,
      },
      {
        title: "jul",
        dataIndex: "jul",
        ...
        sorter: (a, b) => a.jul.length - b.jul.length,
      },
      {
        title: "aug",
        dataIndex: "aug",
        ...
        sorter: (a, b) => a.aug.length - b.aug.length,
      },
      {
        title: "sep",
        dataIndex: "sep",
        ...
        sorter: (a, b) => a.sep.length - b.sep.length,
      },
      {
        title: "oct",
        dataIndex: "oct",
        ...
        sorter: (a, b) => a.oct.length - b.oct.length,
      },
      {
        title: "nov",
        dataIndex: "nov",
        ...
        sorter: (a, b) => a.nov.length - b.nov.length,
      },
      {
        title: "dec",
        dataIndex: "dec",
