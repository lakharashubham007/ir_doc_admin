  ...
  const columns = [
    {
      ...
      sorter: (a, b) => a.admissionNo.length - b.admissionNo.length,
    },
    ...
    },
    {
      ...
      sorter: (a, b) => a.english.length - b.english.length,
    },
    {
      title: "Spanish",
      dataIndex: "spanish",
      ...
      sorter: (a, b) => a.spanish.length - b.spanish.length,
    },
    {
      title: "Physics",
      dataIndex: "physics",
      sorter: (a, b) => a.physics.length - b.physics.length,
    },
    {
      title: "Chemistry",
      dataIndex: "chemistry",
      ...
      sorter: (a, b) => a.chemistry.length - b.chemistry.length,
    },
    {
      title: "Maths",
      dataIndex: "maths",
      ...
      sorter: (a, b) => a.maths.length - b.maths.length,
    },
    {
      title: "Computer",
      dataIndex: "computer",
      sorter: (a, b) => a.computer.length - b.computer.length,
    },
    {
      title: "Env Science",
      dataIndex: "envScience",
      sorter: (a, b) => a.envScience.length - b.envScience.length,
    },
    {
      title: "Total",
      dataIndex: "total",
    ...
    },
    {
      title: "Percent",
      dataIndex: "percent",
      sorter: (a, b) => a.percent.length - b.percent.length,
    },
    {
      title: "Grade",
      dataIndex: "grade",
