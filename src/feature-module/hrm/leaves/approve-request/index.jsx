...
const ApproveRequest = () => {
  ...
  const data = approveRequest.map((item, index) => ({
    ...item,
    key: item.id || `row-${index}` // Use existing id or create a unique key
  }));
  const columns = [
    {
      title: "Submitted By",
...

    {
      ...
      render: (text, record, index) => (
        <div key={`status-${record.id || index}`}>
          {text === "Approved" ? (
                    ...
                    <div className="d-flex align-items-center check-radio-group">
                      ...
                      <label className="custom-radio">
                        <input
                          type="radio"
                          name="approvalStatus"
                          checked={approvalStatus === 'Disapproved'}
